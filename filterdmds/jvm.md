...
### <a name="За-что-отвечает-JVM"></a>За что отвечает _JVM_:
...
### <a name="Classloader"></a>Classloader
...
### <a name="Области-данных-времени-выполнения"></a>Области данных времени выполнения
...
### <a name="Execution-Engine"></a>Execution Engine
