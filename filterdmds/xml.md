...
### <a name="Что-такое-xml"></a>Что такое _XML_?
...
### <a name="Что-такое-dtd"></a>Что такое _DTD_?
...
### <a name="Чем-well-formed-xml-отличается-от-valid-xml"></a>Чем _well-formed XML_ отличается от _valid XML_?
...
### <a name="Что-такое-пространство-имен-в-xml"></a>Что такое «_пространство имен_» в XML?
...
### <a name="Что-такое-xsd-В-чём-его-преимущества-перед-xml-dtd"></a>Что такое XSD? В чём его преимущества перед XML DTD?
...
### <a name="Какие-типы-существуют-в-xsd"></a>Какие типы существуют в XSD?
...
### <a name="Какие-вы-знаете-методы-чтения-xml-Опишите-сильные-и-слабые-стороны-каждого-метода"></a>Какие вы знаете методы чтения XML? Опишите сильные и слабые стороны каждого метода.
...
### <a name="Когда-следует-использовать-dom-а-когда-sax-stax-анализаторы"></a>Когда следует использовать _DOM_, а когда _SAX_, _StAX_ анализаторы?
...
### <a name="Какие-вы-знаете-способы-записи-xml"></a>Какие вы знаете способы записи XML?
...
### <a name="Что-такое-jaxp"></a>Что такое _JAXP_?
...
### <a name="Что-такое-xslt"></a>Что такое _XSLT_?
