...
### <a name="Что-такое-ООП"></a>Что такое _ООП_?
...
### <a name="Назовите-основные-принципы-ООП"></a>Назовите основные принципы _ООП_.
...
### <a name="Что-такое-инкапсуляция"></a>Что такое _«инкапсуляция»_?
...
### <a name="Что-такое-наследование"></a>Что такое _«наследование»_?
...
### <a name="Что-такое-полиморфизм"></a>Что такое _«полиморфизм»_?
...
### <a name="Что-такое-абстракция"></a>Что такое _«абстракция»_?
...
### <a name="Что-представляет-собой-обмен-сообщениями"></a>Что представляет собой _«обмен сообщениями»_?
...
### <a name="Расскажите-про-основные-понятия-ООП-класс-объект-интерфейс"></a>Расскажите про основные понятия ООП: _«класс»_, _«объект»_, _«интерфейс»_.
...
### <a name="В-чем-заключаются-преимущества-и-недостатки-объектно-ориентированного-подхода-в-программировании"></a>В чем заключаются преимущества и недостатки объектно-ориентированного подхода в программировании?
...
### <a name="Что-подразумевают-в-плане-принципов-ООП-выражения-является-и-имеет"></a>Что подразумевают в плане принципов ООП выражения _«является»_ и _«имеет»_?
...
### <a name="В-чем-разница-между-композицией-и-агрегацией"></a>В чем разница между _композицией_ и _агрегацией_?
...
### <a name="Что-такое-статическое-и-динамическое-связывание"></a>Что такое _статическое_ и _динамическое связывание_?
